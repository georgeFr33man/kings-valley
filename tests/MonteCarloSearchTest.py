...
import game as g
from ai_algorithms import MonteCarloSearch
...
class MonteCarloSearchTest:
    ...
    def run(self):
        ...
        print("Running monte carlo tests on " + str(self.__testCases) + " tests cases with " + str(self.__depth) + " simulations.")
        mcs = MonteCarloSearch(self.__depth)
